  ...
  return (
    <div className="editCase" id={id} style={caseStyle}>
      ...
      <EditField
        item={otn}
        label="OTN: "
        modifier={getPropertyModifier("otn")}
      />
      <EditField item={dc} label="DC: " modifier={getPropertyModifier("dc")} />
      <EditField
        item={status}
        label="Status: "
        modifier={getPropertyModifier("status")}
      />
      <EditField
        item={county}
        label="County: "
        modifier={getPropertyModifier("county")}
      />
      <EditField
        item={judge}
        label="Judge: "
        modifier={getPropertyModifier("judge")}
      />
      <EditField
        item={judge_address}
        label="Judge Address: "
        modifier={getPropertyModifier("judge_address")}
      />
      <EditField
        item={arrest_date}
        fieldType="date"
        label="Arrest Date: "
        modifier={getPropertyModifier("arrest_date")}
      />
      <EditField
      ...
      <EditField
        item={total_fines}
        label="Total Fines: "
        modifier={getPropertyModifier("total_fines")}
      />
      <EditField
        item={fines_paid}
        label="Fines Paid: "
        modifier={getPropertyModifier("fines_paid")}
      />
      <EditField
        item={complaint_date}
        fieldType="date"
        label="Complaint Date: "
        modifier={getPropertyModifier("complaint_date")}
      />
      <EditField
        item={affiant}
        label="Affiant: "
        modifier={getPropertyModifier("affiant")}
      />
      <EditField
        item={arresting_agency}
        label="Arresting Agency: "
        modifier={getPropertyModifier("arresting_agency")}
      />
      <EditField
        item={arresting_agency_address}
        label="Arresting Agency Address: "
        modifier={getPropertyModifier("arresting_agency_address")}
      />
      <div></div>
      <div></div>
